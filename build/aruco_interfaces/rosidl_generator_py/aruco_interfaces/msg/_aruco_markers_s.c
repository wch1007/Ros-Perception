...
bool aruco_interfaces__msg__aruco_markers__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aruco_interfaces.msg._aruco_markers.ArucoMarkers", full_classname_dest, 48) == 0);
  }
  aruco_interfaces__msg__ArucoMarkers * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of ArucoMarkers */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aruco_interfaces.msg._aruco_markers");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArucoMarkers");
