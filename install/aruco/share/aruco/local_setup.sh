...
: ${AMENT_CURRENT_PREFIX:="/home/rosdev/ros2_ws/install/aruco"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/aruco/environment/pythonpath.sh"
